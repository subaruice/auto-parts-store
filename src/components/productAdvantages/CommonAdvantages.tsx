const CommonAdvantages = () => {
    return (
        <div className="w-full flex-col flex lg:flex-row gap-3 mt-5 text-black/80">
            <div className="flex-1/3 pr-3">
                <div className="flex gap-2">
                    <img className="self-start w-[51px] h-[51px] object-contain" src="/auto-parts-store/common-adventure-1.png" alt="" />
                    <p>
            ...
            <div className="flex-1/3 pr-3">
                <div className="flex gap-2">
                    <img className="self-start w-[51px] h-[51px] object-contain" src="/auto-parts-store/common-adventure-2.png" alt="" />
                    <p>
            ...
            <div className="flex-1/3">
                <div className="flex gap-2">
                    <img className="self-start w-[51px] h-[51px] object-contain" src="/auto-parts-store/common-adventure-3.png" alt="" />
                    <p>
