                ...
                <div className="flex flex-col gap-4">
                    {products.map((product: any) => (
                        <div key={product.productID} className="flex items-center">
                            ...
                            <Link to={`/category/${product.categoryID}/products/${product.productID}`} className="flex-1 pr-4 font-medium text-black/80 text-[17px]">{product.name}</Link>
                            ...
                            <X onClick={() => clearProducts(product.productID)} className="cursor-pointer hover:stroke-red-700" color="#fd3535" />
                        </div>
                    ))}
                </div>
