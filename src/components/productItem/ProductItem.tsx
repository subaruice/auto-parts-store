                ...
                <div className="flex gap-10">
                    <div className="min-w-[40%] max-w-[50%]">
                        {product.pictures &&
                            product.pictures.map((pic: PicObj) => (
                                <img src={`http://milotec.com.ua/pictures/${pic.enlarged}`} alt="no image" />
                            ))}
                    </div>
                    <div className="flex flex-col gap-4 w-full">
                        ...
                        <div className="w-full gap-2 flex justify-end">
                            <input className="border border-[#eceff1] rounded-[5px] w-10 outline-none input-no-spinner" type="number" placeholder="0"
                                value={quantity}
