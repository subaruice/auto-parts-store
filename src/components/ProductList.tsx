    ...
    return (
        <div className="flex gap-3 justify-center flex-wrap">
            {items.map(({name, in_stock, Price, product_code}) => 
                <div className="p-3 w-[300px] border-[0.5px] rounded-[10px] border-black/30 h-auto flex flex-col ">
                    ...
                    <div className="flex justify-center items-center">
                        <button className="py-3 rounded-[7px] w-full text-white font-medium bg-red-700">В корзину</button>
                    </div>
                    <div></div>
                </div>
            )}
